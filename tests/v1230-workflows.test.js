...
test('v1.23 sensitive workflows require confirmed Telegram delivery',()=>{
  ...
  assert.match(s,/LOSS_COMPLAINT[\s\S]{0,1400}requireTelegramDelivery:true/);
});

test('v1.23 link and registration info also notify Telegram',()=>{
  ...
  assert.match(e,/PERMINTAAN DAFTAR/);
