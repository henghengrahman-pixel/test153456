...
async function resolveContextualIntent(chatId,currentIntent,text,attachments=[]){
  ...
  if(['DEPOSIT_PROBLEM','WITHDRAW_PROBLEM','WITHDRAW_REQUEST','FORGOT_PASSWORD','BONUS_REQUEST','BONUS_DAILY','ACCOUNT_CHANGE_REQUEST','PAYOUT_NOT_RECEIVED','BANK_ACCOUNT_LIMIT','REGISTER_PROBLEM','LINK_PROBLEM','LOGIN_PROBLEM','GAME_PROBLEM','GENERAL_DISTURBANCE','LOSS_COMPLAINT'].includes(current)) return current;
