const typoMap = new Map(Object.entries({
  ...
  'knp':'kenapa','kpn':'kapan','skrg':'sekarang','tdk':'tidak','gngguan':'gangguan','gangguanx':'gangguan','limid':'limit','limitt':'limit','eror':'error','errorr':'error','loginn':'login','ligin':'login','lgin':'login','lupa':'lupa','lpa':'lupa','lp':'lupa','lup':'lupa','alihin':'alihkan','alihkn':'alihkan','rek':'rekening',
