...
async function load(){
  ...
  $('#healthDetails').innerHTML=`<pre>${esc(JSON.stringify({poller:s.poller,cannedSync:s.cannedSync,humanBridge:s.humanBridge,integrationHealth:s.integrationHealth,operations:o},null,2))}</pre>`
}
