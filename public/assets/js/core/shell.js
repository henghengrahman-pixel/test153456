...
const iconMap={conversations:'◫','case-management':'◇',knowledge:'▤','ai-rules':'⌘',responses:'≡','menu-penting':'★','bekal-bot':'◆','canned-responses':'#','telegram-cta':'↗','telegram-settings':'✦','website-profile':'◎','ai-settings':'⚙',learning:'↻',logs:'☷','system-health':'♥',security:'⌾'};
